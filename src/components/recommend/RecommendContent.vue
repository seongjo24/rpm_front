    ...
    export default {
        ...
        methods: {
            ...
            removeData(){
                ...
                const url = this.$store.state.contents.context + 'recommendedCar/recommendedCarRemove'
                axios
                    .post(url,this.checkedList)
                    .then(()=>{
                        location.reload()
                        this.$alert('삭제완료')
        ...
        mixins:[checkBox],
        created() {
          let url = this.$store.state.contents.context + 'recommendedCar/getRecommendedCar/'+localStorage.getItem("userId")
            axios
                .get(url)
                        .then(({data})=>{
                            data.forEach(el=>{
