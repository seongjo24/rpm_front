...
const actions = {
    ...
    async getCategory1({commit}, param){
      let url = state.context + 'getcategory/'+param.param+'/'+param.column
        axios
            .get(url)
            .then(({data})=>{
    ...
    async searchWithCondition({commit}, param){
      const url = state.context + 'searchWithCondition'
        let headers = {
    ...
    async pageClick({ commit }, data){
      let url = state.context + 'getshowcarlist/'+data.start+'/'+data.end
      axios
            .get(url)
            .then(({data})=>{
    ...
    async stringMatch({commit}, searchKeyWord){
      let url = state.context + 'stringMatch/'+searchKeyWord
        axios
            .get(url)
            .then(({data})=>{
    ...
    async getSearchWordRank({commit}){
      const url = state.context + 'searchWordRank'
        axios
            .get(url)
            .then(({data})=>{
    ...
    async getRecommendBySearchWord({commit}, searchWord){
      let url = state.context + 'getRecommendBySearching/'+searchWord
        axios
            .get(url)
            .then(({data})=>{
